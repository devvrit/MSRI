...
Consider a dataset of $n$ points in $\sqrt{n}$ buckets of $\sqrt{n}$ points each arranged in a grid-like fashion. Points within a bucket are simialr to each other, while points lying 
